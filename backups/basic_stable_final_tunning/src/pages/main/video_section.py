...
class VideoSection(BaseSection):
    ...
    def _create_video_tree(self):
        ...
        try:
            ...
            self.video_tree.tag_configure("playlist_hit", background="#e6f2ff", foreground="#004a99")
            self.video_tree.tag_configure("video_hit", background="#ffe6f0", foreground="#99004a")
        except Exception:
            pass
    ...
    def _create_action_buttons(self):
        ...
        try:
            ...
            ttk.Button(button_frame, text="Save Playlist", 
                      command=lambda: messagebox.showerror("Error", "Save Playlist is unavailable.")).pack(side="left", padx=5)
        
        # Add debug print to verify button click
        self.download_btn = ttk.Button(
            button_frame, 
            text="Download Videos", 
            command=lambda: print("Download button clicked") or getattr(self.main_page, 'download_playlist_videos', lambda: None)()
        )
